  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute bottom-8 sm:bottom-12 left-0 right-0 text-center px-4 sm:px-6 pointer-events-none drop-shadow-[0_2px_8px_rgba(0,0,0,0.9)]">
          ...
          <p className="text-base sm:text-lg md:text-xl leading-relaxed text-gray-200 max-w-xl mx-auto">
